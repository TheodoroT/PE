...
function setupPhoneAuth() {
    ...
    document.getElementById('phone-submit-btn')?.addEventListener('click', async () => {
        ...
        if (!_phoneConfirmation) {
            ...
            if (!phone) return showLoginError('Digite o número com código do país. Ex: +55 11 99999-9999');
            if (!phone.startsWith('+')) return showLoginError('Inclua o código do país. Ex: +55 para Brasil');
